        ...
        <div className="mt-5 md:mt-0 basis-full md:basis-[49.3%]">
            <div className="widget mb-5">
                <div className="font-bold p-5 py-3 flex justify-between items-center">
                    <h3>신규 게시글</h3>
                    <Link href="/admin/member" className="focus:outline-none text-white font-medium rounded-lg text-sm p-5 py-2.5">게시글 전체</Link>
                </div>
                        ...
                        postData && postData.map((e,i)=>{
                            ...
                            return(
                                <ul key={i} className="flex justify-between border-b last:border-0 items-center">
                                        <li className="basis-[33%] font-bold text-center text-xs sm:text-sm py-2.5">{e.username}</li>
                                        <li className="basis-2/5 font-bold text-center text-xs sm:text-sm py-2.5">{e.title}</li>
            ...
            <div className="widget md:mb-5">
                <div className="font-bold p-5 py-3 flex justify-between items-center">
                    <h3>신규 댓글</h3>
                    <Link href="/admin/member" className="focus:outline-none text-white focus:ring-4 font-medium rounded-lg text-sm p-5 py-2.5">댓글 전체</Link>
                </div>
                <div className="w-full">
                    <ul className="flex py-4 text-sm justify-between border-b">
                        <li className="basis-[33%] font-bold text-center text-xs sm:text-sm">이름</li>
