            ...
            credentials: {
              ...
              async authorize(credentials): Promise<User | null> {
                ...
                try{
                    ...
                    const [results] = await db.query<RowDataPacket[]>('select * from musicboard.member where email= ?',[credentials?.email])
                    ...
                    const pwCheck = await bcrypt.compare(credentials.password,
                        userResult?.password)
